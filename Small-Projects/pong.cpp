...
class Game : public r4GameEngine {
    ...
    bool OnUpdate(double elapsedTime) { 
        ...
        // Display score
        DrawText(ScreenWidth()/4, 10, std::to_string(nScore0), ALIGN_CENTER);
        DrawText(ScreenWidth()*3/4, 10, std::to_string(nScore1), ALIGN_CENTER);
